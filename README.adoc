...
== Schritte
1. Datenbank erstellen und JPA Schnittstelle erstellen https://github.com/choffmann/javaEE-forum/tree/main/Doku/Database[siehe Doku]
2. REST Schnittstelle definieren https://github.com/choffmann/javaEE-forum/tree/main/Doku/REST_Api[siehe Doku]
